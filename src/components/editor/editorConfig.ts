export const DEFAULT_BIBLE_ENDPOINT_PATH = process.env.BIBLE_ENDPOINT_URL || 'bible/passage.php';
...
export const IMAGE_UPLOAD_URL =
  process.env.IMAGE_UPLOAD_URL || 'http://localhost/trailwright/public/api/upload-image.php';
